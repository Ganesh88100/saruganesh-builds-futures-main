      ...
      <div className="container-custom">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/Ganesh88100"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/saruganesh1012/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors duration-200"
              >
              ...
              <a
                href="mailto:saruganesh1012@gmail.com"
                className="text-white/60 hover:text-white transition-colors duration-200"
              >
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-white/60 text-sm text-center sm:text-left">
            © {currentYear} Saruganesh. Made with React & Tailwind CSS
          </p>
